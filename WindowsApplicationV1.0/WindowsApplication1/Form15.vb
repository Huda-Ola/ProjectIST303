...
Public Class Form15
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Me.GUIDED_HIKINGTableAdapter.FillBy(Me.DatabaseIST303DataSet8.GUIDED_HIKING, "")
        TextBox4.Text = ""
        TextBox2.Text = ""
        TextBox5.Text = ""
        TextBox1.Text = ""
        ...
        Try
            ...
            Using reader
                While reader.Read
                    ...
                    Me.GUIDED_HIKINGTableAdapter.FillBy(Me.DatabaseIST303DataSet8.GUIDED_HIKING, TextBox3.Text)
                End While
            End Using
        Finally
            ...
            For Each r As DataGridViewRow In DataGridView1.Rows
                ...
                If r.Cells(4).Value = True Then
                    ...
                    Try
                        ...
                        cmd.CommandText = "DELETE GUIDED_HIKING.* FROM GUIDED_HIKING WHERE ((GUIDED_HIKING.GH_ID =" + r.Cells(0).Value.ToString + "));"
