...
Public Class Form16
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Me.MASSAGETableAdapter.FillBy(Me.DatabaseIST303DataSet9.MASSAGE, "")
        TextBox4.Text = ""
        TextBox2.Text = ""
        TextBox5.Text = ""
        TextBox1.Text = ""
        ...
        Try
            ...
            Using reader
                While reader.Read
                    ...
                    Me.MASSAGETableAdapter.FillBy(Me.DatabaseIST303DataSet9.MASSAGE, TextBox3.Text)
                End While
            End Using
        Finally
            ...
            For Each r As DataGridViewRow In DataGridView1.Rows
                ...
                If r.Cells(4).Value = True Then
                    ...
                    Try
                        ...
                        cmd.CommandText = "DELETE MASSAGE.* FROM MASSAGE WHERE ((MASSAGE.MS_ID =" + r.Cells(0).Value.ToString + "));"
