...
Public Class Form17
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Me.LASSOINGTableAdapter.FillBy(Me.DatabaseIST303DataSet10.LASSOING, "")
        TextBox4.Text = ""
        TextBox2.Text = ""
        TextBox5.Text = ""
        TextBox1.Text = ""
        ...
        Try
            ...
            Using reader
                While reader.Read
                    ...
                    Me.LASSOINGTableAdapter.FillBy(Me.DatabaseIST303DataSet10.LASSOING, TextBox3.Text)
                End While
            End Using
        Finally
            ...
            For Each r As DataGridViewRow In DataGridView1.Rows
                ...
                If r.Cells(4).Value = True Then
                    ...
                    Try
                        ...
                        cmd.CommandText = "DELETE LASSOING.* FROM LASSOING WHERE ((LASSOING.LC_ID =" + r.Cells(0).Value.ToString + "));"
