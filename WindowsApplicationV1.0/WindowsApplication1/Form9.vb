...
Public Class Form9
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        ...
        s_time2 = s_time1.Substring(s_time1.IndexOf(":"))
        s_time2 = s_time2.Replace("3", "0")
        s_time2 = s_time3 + s_time2
        ...
        If stype = "30" Then
            cmd1.CommandText = "SELECT * FROM MASSAGE WHERE ((MS_date = #" + DateTimePicker1.Text + "#) AND (((MS_Type = '" + stype + "') AND (MS_time = '" + ComboBox1.SelectedItem.ToString + "')) OR ((MS_Type = '60') AND (MS_time = '" + s_time2 + "'))))"


        Else
            s_time1 = ComboBox1.SelectedItem.ToString
            s_time3 = s_time1.Remove(s_time1.IndexOf(":"))
            s_time2 = s_time1.Substring(s_time1.IndexOf(":") + 2)

            s_time2 = s_time3 + ":3" + s_time2

            'MsgBox(s_time1 + "================" + s_time2)

            cmd1.CommandText = "SELECT * FROM MASSAGE WHERE ((MS_date = #" + DateTimePicker1.Text + "#) AND (MS_time = '" + ComboBox1.SelectedItem.ToString + "') OR ((MS_Type = '30') AND (MS_time = '" + s_time2 + "')))"
        ...
        Try
            ...
            While reader1.Read
                ...
                If stype = "60" And reader1.GetValue(3) = "30" Then
            ...
            TextBox6.Text = (6 - reservedSpots).ToString
                ...
                If CInt(TextBox6.Text) >= CInt(TextBox7.Text) Then
                    ...
                    Try
                        ...
                        For i = 1 To CInt(TextBox7.Text)
                            cmd1.CommandText = "INSERT INTO MASSAGE (MS_date,MS_time,MS_Type,Phone_No,MS_Price) VALUES ('" + DateTimePicker1.Text + "','" + ComboBox1.SelectedItem + "','" + stype + "','" + TextBox1.Text + "'," + price.ToString + ");"
