...
Public Class Form8
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        ...
        cmd1.CommandText = "SELECT * FROM GUIDED_HIKING WHERE ((GH_date = #" + DateTimePicker1.Text + "#) AND (GH_Type = '" + stype + "') AND (GH_time = '" + ComboBox1.SelectedItem.ToString + "'))"
        ...
        Try
            ...
            End While
            TextBox6.Text = (8 - reservedSpots).ToString
                ...
                If CInt(TextBox6.Text) >= CInt(TextBox7.Text) Then
                    ...
                    Try
                        ...
                        For i = 1 To CInt(TextBox7.Text)
                            cmd1.CommandText = "INSERT INTO GUIDED_HIKING (GH_date,GH_time,GH_Type,Phone_No,GH_Price) VALUES ('" + DateTimePicker1.Text + "','" + ComboBox1.SelectedItem + "','" + stype + "','" + TextBox1.Text + "'," + price.ToString + ");"
